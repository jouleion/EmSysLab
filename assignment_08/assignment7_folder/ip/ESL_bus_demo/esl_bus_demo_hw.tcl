...
add_interface_port encoder pitch_enc_a export Input 1
add_interface_port encoder pitch_enc_b export Input 1
add_interface_port encoder yaw_enc_a   export Input 1
add_interface_port encoder yaw_enc_b   export Input 1

## Force ports to be exported
...
add_interface_port gpio sw export Input 4
add_interface_port gpio led export Output 8
##################################################
